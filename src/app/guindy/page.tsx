...
export const metadata:Metadata = {
    title: "Coworking Space in Guindy | Business Centers in Guindy | Shared Office Space Rent in Guindy, Chennai - Ecowrkz",
    description: "Coworking Space in Guindy, Business Centers in Guindy, and Shared Office Space Rent in Guindy offer great amenities such as a fully furnished office, meeting room, etc. Get a 10% offer on premium booking.",
    keywords: [
...
"shared office space for rent in chennai",
    ...
    alternates: {
        canonical: "https://ecowrkz.com/guindy/",
        languages: {
        "en-US": "https://ecowrkz.com/guindy/en"
        }
    },
    openGraph: {
        title: "Coworking Space in Guindy | Business Centers in Guindy | Shared Office Space Rent in Guindy, Chennai - Ecowrkz",
        description: "Coworking Space in Guindy, Business Centers in Guindy, and Shared Office Space Rent in Guindy offer great amenities such as a fully furnished office, meeting room, etc. Get a 10% offer on premium booking.",
        url: "https://ecowrkz.com/guindy/",
