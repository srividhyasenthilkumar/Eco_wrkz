...
"shared office space for rent in chennai",
    ...
    alternates: {
        canonical: "https://ecowrkz.com/t-nagar/",
        languages: {
        "en-US": "https://ecowrkz.com/t-nagar/en"
        }
    },
...
export default function tNagarOffice(){
    return(
        <>
  ...
  <section className="max-w-7xl mx-auto px-6 py-16 my-5">
      <p className="lg:text-4xl text-3xl font-bold text-center">Our Co-working and Business Centers in T. Nagar</p>
